...
pub fn add_component(component_tag: String, html_data: String) -> String {
    ...
    let css_loaded: String = read_file(css_path);

    let html_path: String = String::from("./templates/components/") + &component_tag.to_lowercase() + &String::from(".html");
    let html_loaded: String = read_file(html_path);
