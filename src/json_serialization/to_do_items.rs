...
///
/// # Parameters
/// * pending_items (Vec<Base>): vector containing the staatuses and titles of pending items
/// * done_items (Vec<Base>): vector containing the statuses and titles of the done items
/// * pending_item_count (i8): the nubmer of pending items
...
impl Responder for ToDoItems {
    ...
    /// This function gets fired when the struct is being retured in the actix view.
    ///
    /// # Arguments
    /// * _req (&HttpRequest): the request belinging to the view
    ///
    /// # Returns
